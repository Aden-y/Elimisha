...
<div class="edit-profile-left">
 <div class="form-group">
    <label for="exampleInputEmail1"><b>Username:</b> <span > Joakim</span></label>
    <button class="fas fa-edit edit-right" id="edit-username-btn">Edit</button>
    <input type="text" class="form-control " id="edit-username-field" aria-describedby="emailHelp" placeholder="Enter email" style="display: none">
    <small id="edit-username-error" class="form-text text-muted" style="color: red;"></small>
  </div>
   <div class="form-group">
    <label for="exampleInputEmail1"><b>Email:</b> <span > princejoachime@gmail.com</span></label>
